...
template <class Ptr> struct pointer_traits_element_type_impl {};
...
template <class Ty, class = void> struct pointer_traits_difference_type {
...
template <class Tp, class Up> struct pointer_traits_rebind_impl {
  static_assert(false, "Cannot rebind pointer; did you forget to add a rebind "
...
// pointer traits impl
template <class Ptr, class = void> struct pointer_traits_impl {};
...
struct pointer_traits_impl<
  ...
  static pointer
  pointer_to(tinystl::conditional_t<tinystl::is_void_v<element_type>, char,
                                    element_type> &r) {
